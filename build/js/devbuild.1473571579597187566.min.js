/*
 java_script_data_types 2016-09-11 
*/
...
var h=a(d);this.activate(b.closest("li"),c),this.activate(h,h.parent(),function(){e.trigger({type:"hidden.bs.tab",relatedTarget:b[0]}),b.trigger({type:"shown.bs.tab",relatedTarget:e[0]})})}}},c.prototype.activate=function(b,d,e){function f(){g.removeClass("active").find("> .dropdown-menu > .active").removeClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!1),b.addClass("active").find('[data-toggle="tab"]').attr("aria-expanded",!0),h?(b[0].offsetWidth,b.addClass("in")):b.removeClass("fade"),b.parent(".dropdown-menu").length&&b.closest("li.dropdown").addClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!0),e&&e()}var g=d.find("> .active"),h=e&&a.support.transition&&(g.length&&g.hasClass("fade")||!!d.find("> .fade").length);g.length&&h?g.one("bsTransitionEnd",f).emulateTransitionEnd(c.TRANSITION_DURATION):f(),g.removeClass("in")};var d=a.fn.tab;a.fn.tab=b,a.fn.tab.Constructor=c,a.fn.tab.noConflict=function(){return a.fn.tab=d,this};var e=function(c){c.preventDefault(),b.call(a(this),"show")};a(document).on("click.bs.tab.data-api",'[data-toggle="tab"]',e).on("click.bs.tab.data-api",'[data-toggle="pill"]',e)}(jQuery),+function(a){"use strict";function b(b){return this.each(function(){var d=a(this),e=d.data("bs.affix"),f="object"==typeof b&&b;e||d.data("bs.affix",e=new c(this,f)),"string"==typeof b&&e[b]()})}var c=function(b,d){this.options=a.extend({},c.DEFAULTS,d),this.$target=a(this.options.target).on("scroll.bs.affix.data-api",a.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",a.proxy(this.checkPositionWithEventLoop,this)),this.$element=a(b),this.affixed=null,this.unpin=null,this.pinnedOffset=null,this.checkPosition()};c.VERSION="3.3.6",c.RESET="affix affix-top affix-bottom",c.DEFAULTS={offset:0,target:window},c.prototype.getState=function(a,b,c,d){var e=this.$target.scrollTop(),f=this.$element.offset(),g=this.$target.height();if(null!=c&&"top"==this.affixed)return c>e?"top":!1;if("bottom"==this.affixed)return null!=c?e+this.unpin<=f.top?!1:"bottom":a-d>=e+g?!1:"bottom";var h=null==this.affixed,i=h?e:f.top,j=h?g:b;return null!=c&&c>=e?"top":null!=d&&i+j>=a-d?"bottom":!1},c.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset;this.$element.removeClass(c.RESET).addClass("affix");var a=this.$target.scrollTop(),b=this.$element.offset();return this.pinnedOffset=b.top-a},c.prototype.checkPositionWithEventLoop=function(){setTimeout(a.proxy(this.checkPosition,this),1)},c.prototype.checkPosition=function(){if(this.$element.is(":visible")){var b=this.$element.height(),d=this.options.offset,e=d.top,f=d.bottom,g=Math.max(a(document).height(),a(document.body).height());"object"!=typeof d&&(f=e=d),"function"==typeof e&&(e=d.top(this.$element)),"function"==typeof f&&(f=d.bottom(this.$element));var h=this.getState(g,b,e,f);if(this.affixed!=h){null!=this.unpin&&this.$element.css("top","");var i="affix"+(h?"-"+h:""),j=a.Event(i+".bs.affix");if(this.$element.trigger(j),j.isDefaultPrevented())return;this.affixed=h,this.unpin="bottom"==h?this.getPinnedOffset():null,this.$element.removeClass(c.RESET).addClass(i).trigger(i.replace("affix","affixed")+".bs.affix")}"bottom"==h&&this.$element.offset({top:g-b-f})}};var d=a.fn.affix;a.fn.affix=b,a.fn.affix.Constructor=c,a.fn.affix.noConflict=function(){return a.fn.affix=d,this},a(window).on("load",function(){a('[data-spy="affix"]').each(function(){var c=a(this),d=c.data();d.offset=d.offset||{},null!=d.offsetBottom&&(d.offset.bottom=d.offsetBottom),null!=d.offsetTop&&(d.offset.top=d.offsetTop),b.call(c,d)})})}(jQuery);var app=angular.module("MathApp",["ngAnimate","ngSanitize","ngMessages","ui.mask"]);app.controller("HeadController",HeadController);app.controller("NavController",NavController);app.controller("IntroController",IntroController);app.controller("TableController",TableController);app.controller("GuideController",GuideController);HeadController.$inject=["$scope"];NavController.$inject=["$scope"];IntroController.$inject=["$scope"];TableController.$inject=["$scope"];GuideController.$inject=["$scope"];function HeadController($Scope){var vm=this;vm.header=[{settings:{title:"Math Board Converter",subtitle:"Converting all Math's Task"}}]}function NavController(){var vm=this;vm.nav={settings:[{name:"home",color:"color-1",front:"front",back:"back",icon:"fa fa-home fa-4x"},{name:"blog",color:"color-2",front:"front",back:"back",icon:"fa fa-align-left fa-4x"},{name:"photos",color:"color-3",front:"front",back:"back",icon:"fa fa-camera-retro fa-4x"},{name:"about",color:"color-4",front:"front",back:"back",icon:"fa fa-user fa-4x"},{name:"contact",color:"color-5",front:"front",back:"back",icon:"fa fa-comments fa-4x"}]}}function IntroController(){var vm=this;vm.intro={head:{title:"Math Board Coverter"},header:{title:"Welcome, here you're going to find Math conversion easily"},paragraphs:[{description:"Here's your quick and smooth math converter, anytime <span>you</span> want!","class":"col-md-4"},{description:"Get registered and receive the latest math news, anytime <span>you</span> want!","class":"col-md-4"},{description:"Share get a lot of discounts on our latest services made for <span>you</span>!","class":"col-md-4"}]}}function GuideController(){var vm=this;vm.guide={header:{description:"Guide: Follow the walkthrough and share:"},text:[{name:"study","class":"col-md-4",glyphicon:"glyphicon-education",description:"Study cases for your career. Get Certified in a year."},{name:"development","class":"col-md-4",glyphicon:"glyphicon-stats",description:"Constant development and great results in a month."},{name:"business","class":"col-md-4",glyphicon:"glyphicon-briefcase",description:"The best for your business and newtwork development."}]}}app.controller("TableController",TableController);app.controller("MessagesController",MessagesController);TableController.$inject=["$scope"];MessagesController.$inject=["$scope"];function TableController(){var vm=this;vm.textFun=textFun();vm.clearExponential=clearExponential();vm.table=table;function textFun(){vm.val="-";return vm.val.replace(/-/i,"Java Script type methods")}function clearExponential(){vm.value="-";return vm.value.replace(/-/i,"Have Fun!")}vm.table={intro:{text:"Number Testing Tool"},title:[{name:"Esponential"},{name:"Fixed"},{name:"Precision"},{name:"String"},{name:"Ceil"},{name:"Floor"},{name:"Round"},{name:"Absolute"}]}}function MessagesController(){var vm=this;vm.messages={settings:[{name:"required",message:"Enter a number"},{name:"pattern",message:"Wrong pattern"},{name:"minlength",message:"Too short!"},{name:"maxlength",message:"Too long!"}]}}app.controller("HeadInfoController",HeadInfoController);HeadInfoController.$inject=["$scope"];function HeadInfoController(){var vm=this;vm.title={name:"Math Board Converter"};vm.meta={keyOne:{type:"description",value:"Math web online converter"},keyTwo:{type:"keywords",value:"Math, mathematics, converter, web, Java Script"},keyThree:{type:"author",value:"Thiago Lima"}}}