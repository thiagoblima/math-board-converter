 ...
 * @description: View Object <TestMath>
 *
...
View = {
  ...
  events: {
    exponential: function(exponential) {
      ...
      exponential = View.math.results.exponential.innerHTML = JSON.stringify([
        View.math.user.getExponential().toExponential()
      ]);
    ...
    fixed: function(fixed) {
      ...
      fixed = View.math.results.fixed.innerHTML = JSON.stringify([
        View.math.user.getFixed().toFixed(2)
      ]);
    ...
    precision: function(precision) {
      ...
      precision = View.math.results.precision.innerHTML = JSON.stringify([
        View.math.user.getPrecision().toPrecision()
      ]);
    ...
    string: function(string) {
      ...
      string = View.math.results.string.innerHTML = JSON.stringify([
        View.math.user.getString().toString()
      ]);
    ...
    ceil: function(ceil) {
      ...
      ceil = View.math.results.ceil.innerHTML = JSON.stringify([
        View.math.user.getCeil()
      ]);
      return ceil;
    },
    floor: function(floor) {
      View.math.user.setFloor(View.math.setResults.floor.value);
      floor = View.math.results.floor.innerHTML = JSON.stringify([
        View.math.user.getFloor()
      ]);
      return floor;
    },
    round: function(round) {
      View.math.user.setRound(View.math.setResults.round.value);
      round = View.math.results.round.innerHTML = JSON.stringify([
        View.math.user.getRound()
      ]);
      return round;
    },
    absolute: function(absolute) {
      View.math.user.setAbs(View.math.setResults.absolute.value);
      absolute = View.math.results.absolute.innerHTML = JSON.stringify([
        View.math.user.getAbs()
      ]);
      return absolute;
    }
  }
